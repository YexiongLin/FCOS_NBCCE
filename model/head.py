...
class ClsCntRegHead(nn.Module):
    def __init__(self,in_channel,class_num,GN=True,cnt_on_reg=True,prior=0.01):
        ...
        self.cls_logits=nn.Conv2d(in_channel,1+class_num,kernel_size=3,padding=1) #one confidence and class_num
    ...
    def forward(self,inputs):
        ...
        for index,P in enumerate(inputs):
            ...
            cls_logits.append(self.cls_logits(cls_conv_out).sigmoid())
